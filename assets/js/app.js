(function(){
  ...
  function playerLink(item){ const slug=playerSlug(item.player); return slug ? '/'+slug+'/' : null; }
  ...
  function renderDetail(){ /* Player pages are static HTML files. No player_profiles table is used. */ }
